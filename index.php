...
<div id="maincarousel" class="carousel slide carousel-dark" data-bs-ride="carousel" data-bs-pause="false">
            ...
            <div class="carousel-inner">
                <div class="carousel-item main-carousel-item active" data-bs-interval="5000">
                    <img class="hero-carousel" src="img/HOME/slide-1.webp" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item main-carousel-item" data-bs-interval="5000">
                    <img class="hero-carousel"  src="img/HOME/slide-3v2.webp" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <p>Serve with Compassion, sell with consience profit with honor</p>
                ...
                <div class="carousel-item main-carousel-item" data-bs-interval="5000">
                    <img class="hero-carousel" src="img/HOME/Slide 4.webp" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
        ...
        <!-- MAIN -->
            ...
            <div class="about-container">
                ...
                <div class="about-content">
                    ...
                    <a href="about.php"><button class="about-btn">ABOUT OTUS</button></a>
                </div>
            </div>
            <!-- END ABOUT PART -->
            ...
            <div class="why-choose-us-container">
                ...
                <div class="why-choose-us-content">
                    <div class="best-strategy test-1">
